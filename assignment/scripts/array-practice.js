...
let favoriteFoods = ['Quesa Beria','Chicken Tikka Masala','Fufu', 'Lamb chop' ];
...
console.log('Animal arrray ', animalArray);
...
console.log('Animal arrray ', animalArray);
console.log('Last animal --using array length-- ', lastAnimal);
...
let entree = 'Salmon with Lemon Butter Sauce';
favoriteFoods.unshift(entree);
console.log('Added entree to the beginning of favoriteFoods ', favoriteFoods);
...
gems.sort();
gems.reverse();
console.log('Reverse gems are ', gems);
